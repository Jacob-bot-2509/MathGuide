...
const ZH: Dict = {
  ...
  'learn.formulaHint': '点击板块,查询该板块常用公式与定理',
  'learn.formulaJump': '查询该板块公式',
  'learn.formulaAsk': '的常用公式与定理',
...
const EN: Dict = {
  ...
  'learn.formulaHint': 'Click a section to look up its common formulas and theorems',
  'learn.formulaJump': 'Look up formulas',
  'learn.formulaAsk': ' common formulas and theorems',
