...
const ZH: Dict = {
  ...
  'learn.toastConverting': '正在转写为数学符号…',
  'learn.toastConverted': '已转写为数学符号,可修改后再发送',
...
const EN: Dict = {
  ...
  'learn.toastConverting': 'Converting to math notation…',
  'learn.toastConverted': 'Converted to math notation — edit if needed, then send',
