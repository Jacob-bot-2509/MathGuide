...
const ZH: Dict = {
  ...
  'learn.interrupted': '⚠ 回答已中断(连接断开),以上内容可能不完整',
  'learn.exportPdf': '导出 PDF',
  'learn.exporting': '生成中…',
  'learn.exportLangTitle': '导出语言',
  'learn.exportLangZh': '中文',
  'learn.exportLangEn': 'English',
  'learn.exportDone': 'PDF 已生成,开始下载',
  'learn.exportFailed': '导出失败,请稍后重试',
  ...
  'learn.nbPanelTitle': '问题记录',
  'learn.nbPanelTotal': '共 {n} 条',
  'learn.nbPanelHint': '点击词条跳回该问答所在的原对话',
  'learn.nbJump': '跳回原问答',
  ...
  'learn.toastConvertFail': '数学符号转写失败,已保留原文',
...
const EN: Dict = {
  ...
  'learn.interrupted': '⚠ Answer interrupted (connection lost) — the text above may be incomplete',
  'learn.exportPdf': 'Export PDF',
  'learn.exporting': 'Generating…',
  'learn.exportLangTitle': 'Export language',
  'learn.exportLangZh': '中文',
  'learn.exportLangEn': 'English',
  'learn.exportDone': 'PDF generated, download started',
  'learn.exportFailed': 'Export failed, please try again',
  ...
  'learn.nbPanelTitle': 'Question Archive',
  'learn.nbPanelTotal': '{n} entries',
  'learn.nbPanelHint': 'Click an entry to jump back to its conversation',
  'learn.nbJump': 'Jump to conversation',
  ...
  'learn.toastConvertFail': 'Math conversion failed — original text kept',
