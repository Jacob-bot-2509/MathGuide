...
const ZH: Dict = {
  ...
  'learn.nbJump': '跳回原问答',
  'learn.formulaTitle': '公式查询手册',
  'learn.formulaTotal': '共 {n} 个板块',
  'learn.formulaHint': '点击板块后,先说明想查的具体知识点,再给出对应公式与定理',
  'learn.formulaJump': '选择该板块后,指定想查的知识点',
  'learn.formulaClarify': '我想查询{cat}领域的公式和定理,请先询问我想查哪个具体知识点(先不要列出公式)',
...
const EN: Dict = {
  ...
  'learn.formulaTitle': 'Formula Handbook',
  'learn.formulaTotal': '{n} sections',
  'learn.formulaHint': 'Pick a section, name the specific topic, and I will give the matching formulas and theorems',
  'learn.formulaJump': 'Pick this section, then name your topic',
  'learn.formulaClarify': 'I want to look up formulas and theorems in {cat}. Please first ask me which specific topic I want to check (do not list the formulas yet)',
